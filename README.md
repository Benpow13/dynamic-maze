...
Task
-The task involes programming an autonomous robot to navigate around a series of different mazes, with a goal of being able to route 
back and fouth through the maze via the fastest route possible. 

The objectives for this task are:
-Dectect the red title marking the end of the maze
-esacpe the maze via the fastest route
